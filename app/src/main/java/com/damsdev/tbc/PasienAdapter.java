...
public class PasienAdapter extends RecyclerView.Adapter<PasienAdapter.Holder> {
    private List<PasienModel> mListData;
    private Context context;
    private IPasienClick iPasienClick;
    int lastPos = -1;

    public PasienAdapter(List<PasienModel> mListData, Context context, IPasienClick iPasienClick) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        final PasienModel model = mListData.get(position);
